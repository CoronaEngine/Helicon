...
#line 14 "3a276d7dac7068468ee90f46327bd4a7bb36eb7e"
struct global_ubo_struct_0
{
    float4x4 global_var_0_0;
    float3x3 global_var_1_0;
...
#line 28 "3a276d7dac7068468ee90f46327bd4a7bb36eb7e"
struct fragment_output_0
{
    float4 var_43_0 : SV_TARGET0;
};
...
#line 53
    float var_13_0 = _S10 * (_S12 * max(dot(_S6, normalize(_S13 + normalize(ConstantBuffer<global_ubo_struct_0 >(ResourceDescriptorHeap[globalParams_0.global_ubo_0.x]).global_var_6_0 - _S1.var_0_0.fragPos_0))), 0.0f) * -0.9375f + 1.0f);


    float var_16_0 = max(dot(_S6, normalize(ConstantBuffer<global_ubo_struct_0 >(ResourceDescriptorHeap[globalParams_0.global_ubo_0.x]).global_var_4_0 - _S1.var_0_0.fragPos_0)), 0.0f);

#line 61
    float var_21_0 = max(dot(_S6, normalize(ConstantBuffer<global_ubo_struct_0 >(ResourceDescriptorHeap[globalParams_0.global_ubo_0.x]).global_var_6_0 - _S1.var_0_0.fragPos_0)), 0.0f);

#line 72
    float3 var_32_0 = float3(1.0f, 1.0f, 1.0f);

#line 77
    float3 _S14 = var_32_0 - var_4_0;
...
#line 82
    float3 _S17 = (var_32_0 - (var_4_0 + _S14 * pow(clamp(1.0f - clamp(dot(_S16, normalize(ConstantBuffer<global_ubo_struct_0 >(ResourceDescriptorHeap[globalParams_0.global_ubo_0.x]).global_var_4_0 - _S1.var_0_0.fragPos_0)), 0.0f, 1.0f), 0.0f, 1.0f), 5.0f))) * var_1_0 / 3.14159297943115234f;

#line 82
    float _S18 = 0.0625f / var_13_0 * (var_21_0 / (var_21_0 * 0.71875f + 0.28125f) * (var_16_0 / (var_16_0 * 0.71875f + 0.28125f)));
...
#line 82
    ...
    output_0.var_43_0 = float4(float3(0.02999999932944775f, 0.02999999932944775f, 0.02999999932944775f) * var_1_0 + _S24 * max(dot(_S6, normalize(ConstantBuffer<global_ubo_struct_0 >(ResourceDescriptorHeap[globalParams_0.global_ubo_0.x]).global_var_6_0 - _S1.var_0_0.fragPos_0)), 0.0f), 1.0f);
    return output_0;
}
