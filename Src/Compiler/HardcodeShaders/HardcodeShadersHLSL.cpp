...
std::unordered_map<std::string, ShaderCodeModule> HardcodeShaders::hardcodeShadersHLSL = {{"VertexShader_D__Files_Code_Projects_Helicon_Examples_main_cpp", ShaderCodeModule(R"(#pragma pack_matrix(column_major)
...
)"),},{"FragmentShader_D__Files_Code_Projects_Helicon_Examples_main_cpp", ShaderCodeModule(R"(#pragma pack_matrix(column_major)
#ifdef SLANG_HLSL_ENABLE_NVAPI
#include "nvHLSLExtns.h"
#endif
...
)"),},{"ComputeShader_D__Files_Code_Projects_Helicon_Examples_main_cpp", ShaderCodeModule(R"(#pragma pack_matrix(column_major)
#ifdef SLANG_HLSL_ENABLE_NVAPI
#include "nvHLSLExtns.h"
#endif
